...
public class GameTable extends JPanel {
	...
	public void paintComponent(Graphics g) {
		...
		if (showAllDealerCards) {
			...
			g.drawString(Integer.toString(dealer.getTotal()), i + CARD_IMAGE_WIDTH + CARD_INCREMENT,
		...
		g.drawString(Integer.toString(player.getTotal()), i + CARD_IMAGE_WIDTH + CARD_INCREMENT,
				PLAYER_POSITION + CARD_IMAGE_HEIGHT);
	}
}